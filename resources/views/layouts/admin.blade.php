...
<!-- Data Tables -->
        ...
        <script src="{{ asset('admin/plugins') }}/datatables-buttons\js\buttons.server-side.js"></script>
        {{-- <script src="{{ asset('admin/plugins') }}/datatables/buttons.server-side.js"></script> --}}
<!-- AdminLTE App -->
